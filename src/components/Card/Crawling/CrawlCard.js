...
CrawlCard.Footer = function CrawlCardFooter({children, url,isBookmark, onComment, onBookmark, onShare, provider,  count, ...props}){
  return (
    <>
      <div className={styles.card_footer} {...props}>
        <div className={styles.card_footer_box}>
          ...
          <div className={styles.card_footer_box_right}>
            ...
            <CommentIcon onClick={onComment} className={styles.card__icon} count={count} {...props} />
